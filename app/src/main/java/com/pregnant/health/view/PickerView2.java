...
public class PickerView2 extends View {
    ...
    private List<Catalog> mDataList;
    /**
    ...
    public PickerView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setData(List<Catalog> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        Catalog head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        Catalog tail = mDataList.get(mDataList.size() - 1);
    ...
    private void init() {
        timer = new Timer();
        mDataList = new ArrayList<Catalog>();
        //第一个paint
    ...
    private void drawData(Canvas canvas) {
        ...
        canvas.drawText(mDataList.get(mCurrentSelected).getCaption(), x, baseline, mPaint);
        // 绘制上方data
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        float baseline = (float) (y - (fmi.bottom / 2.0 + fmi.top / 2.0));
        canvas.drawText(mDataList.get(mCurrentSelected + type * position).getCaption(),
