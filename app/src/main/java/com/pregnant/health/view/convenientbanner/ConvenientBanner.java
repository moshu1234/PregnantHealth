...
//            LayoutParams layoutParams = (LayoutParams) pointView.getLayoutParams();
//            layoutParams.height = DensityUtils.dp2px(8);
//            layoutParams.width = DensityUtils.dp2px(8);

//            pointView.setLayoutParams(new ViewGroup.LayoutParams(DensityUtils.dp2px(8), DensityUtils.dp2px(8)));
