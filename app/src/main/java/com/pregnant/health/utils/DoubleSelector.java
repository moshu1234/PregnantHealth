...
public class DoubleSelector {
    ...
    public DoubleSelector(Context context, ResultHandler resultHandler, ArrayList<String> data, String defaultSelectItem) {
    ...
    public DoubleSelector(Context context, ResultHandler resultHandler, ArrayList<String> data) {
