 ...
 */
public class SingleSelector3 {
    public interface ResultHandler {
        void handle(Catalog selectItem);

        void handle(Catalog selectItem1, Catalog selectItem2);
    }
    ...
    // 单列构造函数
    public SingleSelector3(Context context, ResultHandler resultHandler, List<Catalog> data, Catalog defaultSelectItem) {
        this(context, resultHandler, data, null, defaultSelectItem, null);
    }

    // 双列构造函数
    public SingleSelector3(Context context, ResultHandler resultHandler, List<Catalog> data, List<Catalog> data2, Catalog defaultSelectItem1, Catalog defaultSelectItem2) {
    ...
    public SingleSelector3(Context context, ResultHandler resultHandler, List<Catalog> data) {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (data2 != null) {
                    ...
                    handler.handle(selectText1, selectText2);
                } else {
                    if (selectText1 == null) {
